document.addEventListener('DOMContentLoaded', () => {
    ...
    const totalImages = 12; // Image number to update
...
function loadImageData() {
    return fetch('../../db/nekomimi_pictures.json') // Database of image data
...
function loadImages() {
    ...
    for (let i = 1; i <= totalImages; i++) {
        const img = new Image();
        img.src = `../images/nekomimi/image${i}.png`; //path to edit
